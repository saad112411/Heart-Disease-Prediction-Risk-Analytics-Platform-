...
class Model:
    ...
    def __init__(self,file_object,logger_object,X,Y):
        ...
        self.logger_object.log(self.file_object, "Training model for combined dataset")
    ...
    def create_model(self,X_train,X_test,y_train,y_test):
        ...
        try:
            ...
            self.lr = Pipeline([('m',LogisticRegression())])
            self.models.append(('logisticRegression',self.lr))
            self.logger_object.log(self.file_object, "Logistic Regression model added")
            ...
            self.nb = Pipeline([('m',GaussianNB())])
            self.models.append(('gaussianNb',self.nb))
            self.logger_object.log(self.file_object, "Gaussian NB model added")
        ...
        # define the voting ensemble
            ...
            self.filename = 'combine_heart.pickle'
